...
public enum Transition
{
	...
	PlayerAppears = 1,  //player is in vision range, Dune Roamer: also outside roll range

	//Dune Roamer
	RollRange = 2,		//in roll range but outside attack range
	AttackRange = 3,	//in attack range
	PlayerImpact = 4,	//while rolling, hits player
	TrapImpact = 5,		//while rolling, rolls over trap
	OtherImpact = 6,	//while rolling, hits wall or other object
